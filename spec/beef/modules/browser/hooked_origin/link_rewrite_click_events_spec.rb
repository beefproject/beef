...
require_relative '../../../../../modules/browser/hooked_origin/link_rewrite_click_events/module'

RSpec.describe Link_rewrite_click_events do
  describe '.options' do
    it 'returns url option' do
      opts = described_class.options
      expect(opts).to be_an(Array)
      expect(opts.first).to include('name' => 'url')
    end
  end
