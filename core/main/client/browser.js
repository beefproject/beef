...
beef.browser = {
    ...
    /**
     * Returns true if the browser is any version of Firefox based on userAgent.
     * @example: beef.browser.isFFuserAgent()
     */
    isFFuserAgent() {
        return /Firefox\/\d+(\.\d+)*/i.test(window.navigator.userAgent);
    },
    ...
    /**
     * Returns true if Chrome based on userAgent.
     * @example: beef.browser.isCuserAgent()
     */
    isCuserAgent: function () {
        return /Chrome\/\d+\.\d+\.\d+\.\d+/.test(window.navigator.userAgent) && !/Edg|OPR|Vivaldi/.test(window.navigator.userAgent);
    },
    ...
    /**
     * Returns true if Opera userAgent.
     * @example: beef.browser.isOuserAgent()
     */
    isOuserAgent: function () {
        return /OPR\/\d+\.\d+\.\d+\.\d+/.test(window.navigator.userAgent);
    },
     ...
     */
    isO: function () {
        return this.isO9_52() || this.isO9_60() || this.isO10() || this.isO11() || this.isO12() || this.isOuserAgent();
    },
