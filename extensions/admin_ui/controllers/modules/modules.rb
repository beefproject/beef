...
# TODO FINISH THIS, not all methods have been changed
  # TODO ------------- AUTHENTICATION!!!! ---------------
  ...
  get '/ui/modules/getRestfulApiToken.json' do 
     {'token' => BeEF::Core::Configuration.instance.get("beef.api_token")}.to_json
  end

  # Returns a JSON array containing the summary for a selected zombie.
  get '/ui/modules/select/zombie_summary.json' do
  ...
  # get the zombie
    ...
    summary_grid_hash.to_json
  end

  # Returns the list of all command_modules in a JSON format
  get '/ui/modules/select/commandmodules/all.json' do
    #command_modules2json(BeEF::Modules.get_enabled.keys)
  end
...
#   get '/ui/modules/select/commandmodules/tree.json' do
#     blanktree = []
#     tree = []
#
...
#     end
#
#     {'success' => 'true', 'commands' => commands}.to_json
#
#   end
#
