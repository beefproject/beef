...
#
class Authenticationng < BeEF::Core::Router::Router

  get '/ui/authentication' do
  ...
  post '/ui/authentication/login' do
    ...
    result =  '{ success : false }' # attempt to fail closed
  ...
  get '/ui/authentication/logout' do
    @session = BeEF::Extension::AdminUI::Session.instance
    (print_error "invalid nonce";return "{ success : true }") if not @session.valid_nonce?(@request)
    (print_error "invalid session";return "{ success : true }") if not @session.valid_session?(@request)
